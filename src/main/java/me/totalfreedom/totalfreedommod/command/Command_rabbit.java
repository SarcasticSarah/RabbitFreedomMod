...
@CommandPermissions(level = Rank.OWNER, source = SourceType.BOTH, blockHostConsole = true)
@CommandParameters(description = "For the bad admins", usage = "/<command> <playername>")
public class Command_rabbit extends FreedomCommand
{
    ...
    public boolean run(final CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        FUtil.bcastMsg(player.getName() + " will be completely obliviated and rabbited!", ChatColor.RED);
        ...
        new BukkitRunnable()
        {
            ...
            public void run()
            {
                ...
                // kick player
                player.kickPlayer(ChatColor.RED + "FUCKOFF, and get your poop together!");
            }
