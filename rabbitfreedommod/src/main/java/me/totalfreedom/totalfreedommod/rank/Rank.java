...
public enum Rank implements Displayable
{
    ...
    HELPER("a", "Helper", Type.ADMIN, "Helper", ChatColor.GOLD),
    RABBIT("a", "Rabbit", Type.ADMIN, "RB", ChatColor.BLUE),
    TELNET_ADMIN("a", "Telnet Admin", Type.ADMIN, "STA", ChatColor.DARK_GREEN),
    SENIOR_ADMIN("a", "Senior Admin", Type.ADMIN, "SrA", ChatColor.GOLD),
    EXECUTIVE_ADMIN("a", "Executive Admin", Type.ADMIN, "Exec-Admin", ChatColor.DARK_RED),
    OWNER("the", "Owner", Type.ADMIN, "Owner", ChatColor.GREEN),
    DEVELOPER("the", "Developer", Type.ADMIN, "Developer", ChatColor.LIGHT_PURPLE),
